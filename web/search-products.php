<?php
    ...
    if ($categoryId == 0) {
        $APIURL = "https://www.ecmapi.boonsiri.co.th/api/v1/product/search-product";
        ...
        $APIURL = "https://www.ecmapi.boonsiri.co.th/api/v1/product/search-product-by-category-id";
        ...
        <a href="<?=rootURL();?>ข้อมูลสินค้าบุญศิริ/<?=$product['id'];?>/<?=str_replace(" ", "-", $product['title']);?>/" class="text-decoration-none">
            <div class="card products-card">
                ...
                ?>
                    ...
                    <p class="card-text text-theme-4 fw-bold">สินค้าชั่งน้ำหนัก</p>
