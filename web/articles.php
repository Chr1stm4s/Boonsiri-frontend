...
<body>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <?php
                ...
                $Response = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/article/list-article", $APIRequest);
    ...
    <?php
        $CategoryResponse = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/article-category/list-article-category");
    ...
    <section class="py-5">
        <div class="container">
            ...
            <?php
                ...
                $ArticleResponse = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/article/list-article", $APIRequest);
