...
<head>
    ...
    <?php
        ...
        $Response = connect_api("$API_Link/v1/article/get-article", $APIRequest);
            ...
            <div class="row">
                <div class="col">
                    ...
                    <?php
                        ...
                        $ArticleHeaderResponse = connect_api("$API_Link/v1/article-detail/list-article-detail", $ArticleHeaderAPIRequest);
                    ...
                    <div class="card bg-theme-3 shadow border-0">
                        <div class="card-body p-3 p-md-5">
                            ...
                            <?php
                                ...
                                $RelateArticleResponse = connect_api("$API_Link/v1/article/list-article", $APIRequest);
