...
<head>
    ...
    <?php
        ...
        $Response = connect_api("$API_Link/v1/case/get-case", $APIRequest);
    ...
    <section class="pb-5">
        <div class="container">
            ...
            <?php
                ...
                $MessageResponse = connect_api("$API_Link/v1/case-message/list-case-message", $MessageAPIRequest);
                ...
                <div class="col-10 col-md-9 col-lg-8 <?=$Side;?>">
                    <div class="card w-100 shadow my-3">
                        ...
                        <?php
                            ...
                            $MessageFileResponse = connect_api("$API_Link/v1/case-file/list-case-file", $MessageFileAPIRequest);
