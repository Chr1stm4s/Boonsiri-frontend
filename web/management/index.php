...
<head>
    ...
    <?php
        ...
        $DataDashboardAPI = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/dashboard/get-dashboard", $DataDashboardRequest);
        ...
        $DataSaleChartAPI = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/dashboard/get-yearly-sales-chart", $DataSaleChartRequest);
        ...
        $DataPieChartAPI = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/dashboard/get-circle-sales-graph", $DataPieChartRequest);
