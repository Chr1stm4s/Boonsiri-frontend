...
<body>
                ...
                <div class="col">
                    <table class="table table-hover border table-striped mb-3" id="DataTables">
                        ...
                        <?php
                            ...
                            $apiUrl = "{$API_URL}promotion/list-promotion";
    ...
    <script>
        ...
        $("#FormEditPromotion").submit(function(e) {
            ...
            $.ajax({
                url: '<?=$API_URL;?>promotion/update-promotion',
                type: 'POST',
                ...
                success: function(response) {
                    if (response.responseCode == "000") {
                        $.ajax({
                            url: '<?=$API_URL;?>promotion/clear-promotion',
                            type: 'POST',
                            contentType: "application/json", 
                            success: function(response) {
                                if (response.responseCode == "000") {
        ...
        $("#FormAddPromotion").submit(function(e) {
            ...
            $.ajax({
                url: '<?=$API_URL;?>promotion/insert-promotion',
                type: 'POST',
                data: JSON.stringify(indexed_array),
                contentType: "application/json", 
                success: function(response) {
