...
<head>
    ...
    <?php
        ...
        $ArticleDataResponse = connect_api("{$API_URL}article/get-article", $ArticleDataRequest);
        ...
        if ($ArticleDataResponse['responseCode'] == "000") {
            ...
            $ArticleDetailsDataResponse = connect_api("{$API_URL}article-detail/get-article-detail", $ArticleDetailsDataRequest);
