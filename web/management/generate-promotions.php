<?php
    ...
    $PromotionDataAPIResponse = connect_api("$API_Link/v1/promotion/get-promotion", $PromotionDataAPIRequest);
    ...
    if ($PromotionDataAPIResponse['responseCode'] == 000) {
        ...
        $GetPromotionOrderDataAPIResponse = connect_api("$API_Link/v1/promotion/list-product-promotion", $GetPromotionOrderDataAPIRequest);
