            ...
            <div class="row">
                ...
                <table class="table table-hover border table-striped mb-3" id="DataTables">
                        ...
                        <?php
                            ...
                            $customersData = connect_api("{$API_URL}customer/list-customer");
                            ...
                            if ($data['responseCode'] == 000) {
                                foreach ($data['cases'] as $cases) {
                                    ...
                                    $CaseStatusAPI = connect_api("{$API_URL}case/get-case", $CaseStatusRequest);
                        ?>
