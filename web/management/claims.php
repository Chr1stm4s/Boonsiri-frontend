            ...
            <div class="row">
                ...
                <table class="table table-hover border table-striped mb-3" id="DataTables">
                        ...
                        <?php
                            ...
                            $customersData = connect_api("{$API_Link}api/v1/customer/list-customer");
                            ...
                            $apiUrl = "{$API_Link}api/v1/case/list-case";
                            ...
                            if ($data['responseCode'] == 000) {
                                foreach ($data['cases'] as $cases) {
                                    ...
                                    $CaseStatusAPI = connect_api("{$API_Link}api/v1/case/get-case", $CaseStatusRequest);
                        ?>
