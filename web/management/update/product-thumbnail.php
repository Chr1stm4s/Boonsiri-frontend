<?php
    ...
    $DataAPIResponse = connect_api("{$API_Link}api/v1/product/get-product-by-id", $DataAPIRequest);
    ...
    if ($DataAPIResponse['responseCode'] == "000") {
        ...
        if ($upload) {
            ...
            $ThumbnailDataAPIResponse = connect_api("{$API_Link}api/v1/product/update-product", $ThumbnailDataAPIRequest);
