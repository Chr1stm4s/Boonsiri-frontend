...
<head>
    ...
    <?php
        ...
        $data = connect_api("https://www.ecmapi.boonsiri.co.th/api/v1/product/get-product-by-id", $requestData);
    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                ...
                <?php
                    $ProductImageAPIURL = "https://www.ecmapi.boonsiri.co.th/api/v1/product/list-product-image";
